        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-row justify-between items-center md:flex-row md:justify-between md:items-center py-3 gap-4">
            ...
            <div className="flex items-center gap-2 text-indigo-900 cursor-pointer" onClick={() => setCurrentView('TRACKER')}>
               ...
               <div>
                  <h1 className="font-display text-xl font-bold tracking-tight leading-none bg-gradient-to-r from-red-600 to-indigo-600 bg-clip-text text-transparent">Minh Huyền Các</h1>
                  <p className="text-[10px] font-semibold tracking-[0.2em] text-slate-400 uppercase mt-1">Product by Vn24h.bnb</p>
               </div>
            </div>
